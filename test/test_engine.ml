        ...
        Alcotest.test_case "players out of moves" `Quick (fun () ->
          ...
          let test_out_of_bounds_move =
            ...
            Alcotest.test_case "wrong board" `Quick (fun () -> 
              ...
              [(H 8,V 0)] (possible_move_list X wrong_size_board))
...
let () =
  ...
  run "Engine"
    [
      ...
      ("possible_move_list", [test_out_of_bounds_move; test_possible_move_list ]);
      ("can_play", [ test_can_play1; test_can_play2; test_can_play3 ]);
      ("win", [ test_win_nonfill_board; test_win_1; test_win_2; test_win_3 ]);
      ( "move",
        [
